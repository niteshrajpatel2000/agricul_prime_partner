                ...
                child: Column(
                  ...
                  children: [
                    ListTile(
                      ...
                      title: Text(
                        '${widget.personalInformationModel.data?.companyName}',
                        ...
                        children: [
                          ...
                          Text.rich(
                            TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text: (widget.dueCollection.branch?.phone?.isNotEmpty ?? false)
                                      ? widget.dueCollection.branch?.phone?.toString() ?? 'n/a'
                                      : widget.personalInformationModel.data?.phoneNumber?.toString() ?? 'n/a',
                                ),
                              ],
                            ),
                          ),
                        ...
                        Flexible(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text.rich(
                                TextSpan(
                                  text: '${widget.personalInformationModel.data?.vatName ?? 'VAT Number'} : ',
                                  children: [
                                    TextSpan(
                                      text: widget.personalInformationModel.data?.vatNo ?? '',
                                    )
                                  ],
                                ),
                                textAlign: TextAlign.end,
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      await printerData.printDueThermalInvoiceNow(invoiceSize: widget.personalInformationModel.data?.invoiceSize, transaction: model, context: context);
                    },
                    child: Container(
                      height: 60,
                      width: context.width() / 3,
