            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                                                              ...
                                                              return Row(
                                                                children: [
                                                                  ...
                                                                  IconButton(
                                                                      ...
                                                                      visualDensity: const VisualDensity(horizontal: -4, vertical: -4),
                                                                      onPressed: () =>
                                                                          DueInvoicePDF.generateDueDocument(transaction[index], data, context, business, download: true),
                                                                      icon: const Icon(
                                                                  ...
                                                                  IconButton(
                                                                      ...
                                                                      visualDensity: const VisualDensity(horizontal: -4, vertical: -4),
                                                                      onPressed: () =>
                                                                          DueInvoicePDF.generateDueDocument(transaction[index], data, context, business, isShare: true),
                                                                      icon: const Icon(
                                                                        Icons.share,
                                                                        color: Colors.grey,
                                                                        size: 22,
                  ...
                  } else Center(child: PermitDenyWidget()),
                ],
              ),
            ),
          );
