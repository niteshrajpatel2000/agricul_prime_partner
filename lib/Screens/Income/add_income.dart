                ...
                child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                          readOnly: true,
                          controller: TextEditingController(text: selectedCategory?.categoryName ?? lang.S.of(context).selectCategory),
                          onTap: () async {
                            selectedCategory = await const IncomeCategoryList().launch(context);
                            setState(() {});
                          },
                              ...
                              if (!permissionService.hasPermission(Permit.incomesCreate.value)) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    ...
                                    content: Text('You do not have permission to create income.'),
                                  ),
                                );
                                return;
                              }
