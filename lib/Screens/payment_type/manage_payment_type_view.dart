                    ...
                    if (!permissionService.hasPermission(Permit.paymentTypesCreate.value)) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          ...
                          content: Text('You do not have permission to create payment type.'),
                        ),
                      );
                      return;
                    }
                  } else {
                    if (!permissionService.hasPermission(Permit.paymentTypesUpdate.value)) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          backgroundColor: Colors.red,
                          content: Text('You do not have permission to update payment type.'),
                        ),
                      );
                      return;
                    }
