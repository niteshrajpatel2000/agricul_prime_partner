...
class PaymentTypeScreenState extends ConsumerState<PaymentTypeScreen> {
  String search = '';
            ...
            children: [
              ...
              Expanded(
                child: paymentTypes.when(data: (data) {
                  if (!permissionService.hasPermission(Permit.paymentTypesCreate.value)) {
                            ...
                            itemBuilder: (context, i) {
                              ...
                              return (_type.name ?? 'N/A').toLowerCase().contains(search.toLowerCase())
                                  ? ListCardWidget(
                                      ...
                                      // Delete
                                      onDelete: () async {
                                        if (!permissionService.hasPermission(Permit.paymentTypesDelete.value)) {
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            SnackBar(
                                              backgroundColor: Colors.red,
                                              content: Text('You do not have permission to delete payment type.'),
                                            ),
                                          );
                                          return;
                                        }
