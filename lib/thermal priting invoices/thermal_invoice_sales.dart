...
class SalesThermalPrinterInvoice {
  ...
  Future<List<int>> getSalesTicket58mm({required PrintSalesTransactionModel printTransactionModel, required List<SalesDetails>? productList}) async {
    ...
    if (printTransactionModel.transitionModel?.branch?.name != null) {
      bytes += generator.text('Branch: ${printTransactionModel.transitionModel?.branch?.name ?? ''}', styles: const PosStyles(align: PosAlign.center));
    }
    ...
    if (printTransactionModel.transitionModel?.branch?.address != null || printTransactionModel.personalInformationModel.data?.address != null) {
      bytes += generator.text(printTransactionModel.transitionModel?.branch?.address ?? printTransactionModel.personalInformationModel.data?.address ?? '',
          styles: const PosStyles(align: PosAlign.center));
    }
    ...
    if (printTransactionModel.transitionModel?.branch?.phone != null || printTransactionModel.personalInformationModel.data?.phoneNumber != null) {
      bytes += generator.text('Tel: ${printTransactionModel.transitionModel?.branch?.phone ?? printTransactionModel.personalInformationModel.data?.phoneNumber ?? ''}',
          styles: const PosStyles(align: PosAlign.center));
    }
    ...
    bytes += generator.text('Invoice: ${printTransactionModel.transitionModel?.invoiceNumber ?? 'Not Provided'}', styles: const PosStyles(align: PosAlign.left));
  ...
  Future<List<int>> getSalesTicket80mm({required PrintSalesTransactionModel printTransactionModel, required List<SalesDetails>? productList}) async {
    ...
    if (printTransactionModel.transitionModel?.branch?.address != null || printTransactionModel.personalInformationModel.data?.address != null) {
      bytes += generator.text('Address: ${printTransactionModel.transitionModel?.branch?.address ?? printTransactionModel.personalInformationModel.data?.address ?? ''}',
          styles: const PosStyles(align: PosAlign.center));
    }
    if (printTransactionModel.transitionModel?.branch?.phone != null || printTransactionModel.personalInformationModel.data?.phoneNumber != null) {
      bytes += generator.text('Mobile: ${printTransactionModel.transitionModel?.branch?.phone ?? printTransactionModel.personalInformationModel.data?.phoneNumber ?? ''}',
          styles: const PosStyles(align: PosAlign.center));
    }
    if (printTransactionModel.personalInformationModel.data?.vatNo != null) {
      bytes += generator.text("${printTransactionModel.personalInformationModel.data?.vatName ?? 'VAT No'}: ${printTransactionModel.personalInformationModel.data?.vatNo}",
